...
yearly_trends_export = export_data.groupby('Year')[['Total_Value']].sum().sort_values(by='Total_Value', ascending=False).reset_index()
fig_yearly_trends_export = px.line(yearly_trends_export, x='Year', y='Total_Value', title="Yearly Export Volume", markers=True)
